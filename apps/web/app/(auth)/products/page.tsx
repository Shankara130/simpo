...
import StockAdjustmentModal, { type StockAdjustmentResult } from '../../../components/inventory/StockAdjustmentModal';
...
export default function ProductsPage() {
  ...
  const [selectedProductForAdjustment, setSelectedProductForAdjustment] = useState<Product | undefined>();
   ...
   * Story 4.3, Task 8.1-8.3: Add "Adjust Stock" button and open modal with pre-selected product
   */
   ...
   * Story 4.3, Task 8.4-8.6: Show toast notification, refresh list, display confirmation
   */
  const handleAdjustmentSuccess = (result: StockAdjustmentResult) => {
    // Show success toast with adjustment details
    addToast({
      productId: result.productId,
      branchId: 0, // Not included in result
      sku: result.sku,
      name: result.name,
      oldStock: result.oldStockQty,
      newStock: result.newStockQty,
      change: result.change,
      updatedBy: result.adjustedBy,
      updatedAt: result.adjustedAt,
    });
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* Adjust Stock Button (Admin/Owner only) */}
